        ...
        return (
            <div>
                ...
                <>
                    <div className="slider position-relative">
                        <div className="slide active position-relative">
                            ...
                            <div className="position-absolute banner-title">
                                A CULINARY RESORT ON ONE OF THE SIX MOST LUXURIOUS BEACHES IN THE WORLD
                            </div>
                        </div>
                        <div className="slide">
                            <img
                        ...
                        <div className="booking position-relative d-flex">
                            ...
                            >
                                <input
                                    ...
                                    type="submit"
                                    defaultValue="MODIFY & CANCEL"
                                />
                            </div>
                        </div>
                    </div>
                    <div className="row mx-0 mt-4" style={{ height: 400 }}>
                    ...
                    <div
                        className="row mx-0"
                        style={{ height: 100, backgroundColor: "rgb(243, 242, 242)" }}
                    >
                        <div className="col-12 d-flex justify-content-center align-items-end pb-2">
                            <h2 style={{ color: "#cbbe73", fontSize: 27 }}>OFFERS &amp; DEAL</h2>
                        </div>
                    </div>
                    <div className="row mx-0 pt-5" style={{ height: 250 }}>
                    ...
                    <div className="mb-5">
                        <div className="row mx-0" style={{ height: 500 }}>
                            <div className="col-6">
                                <img
                            ...
                            <div className="col-6">
                                ...
                                <p className="mt-4">
                                    ...
                                    the beach, the exclusive Lagoon pool surrounded by a tropical garden,
                                    the true Italian flare offered at the Don Cipriani’s, the refined
                                    Asian touch at Café Indochine or the authentic central Vietnam cuisine
                                    at the Danaksara.
                                </p>
                                <button
                                    type="button"
                        ...
                        <div className="row mx-0" style={{ height: 500 }}>
                            <div className="col-6">
                                ...
                                <p className="mt-4">
                                    ...
                                    rooms for 50 to 300 people each. A variety of cultural-themed parties
                                    on the beach or around the lagoon, in the ballrooms or outside the
                                    resort, with the surprising arrivals of VIPs from Helicopter landing
                                    on the resort’s own Helipad…
                                </p>
                                <button
                                    type="button"
                                    style={{ backgroundColor: "rgb(45, 111, 99)", color: "white" }}
                        ...
                        <div className="row mx-0" style={{ height: 500 }}>
                            ...
                            <div className="col-6">
                                ...
                                <p className="mt-4">
                                    ...
                                    Sport House where our experienced staff are waiting to assist or train
                                    you in the use of any of our equipment.
                                </p>
                                <button
                                    type="button"
                                    style={{ backgroundColor: "rgb(45, 111, 99)", color: "white" }}
